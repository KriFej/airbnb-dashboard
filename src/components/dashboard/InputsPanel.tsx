        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
          <div className="flex-1 space-y-1">
            ...
            <p className="text-xs text-muted">
              Coût total d&apos;achat du bien (prix FAI + frais de notaire).
              Utilisé pour calculer la rentabilité annualisée.
            </p>
          ...
          <div className="flex gap-4 sm:gap-6">
            <div className="rounded-xl border border-border bg-surface px-5 py-4 text-center min-w-[110px]">
              <div className="flex items-center justify-center gap-1 text-[11px] uppercase tracking-widest text-dim">
                <TrendingUp size={11} />
                Renta. brute
              </div>
              <div className={`mt-2 text-2xl font-semibold tracking-tight ${kpis.yieldGross !== null ? "text-fg" : "text-dim"}`}>
